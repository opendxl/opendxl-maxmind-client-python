...
with open(os.path.join(CWD, "dxlmaxmindclient", "_version.py")) as f:
...
class LintCommand(Command):
    ...
    def run(self):
        ...
        subprocess.check_call(["pylint", "dxlmaxmindclient", "tests"] +
                              glob.glob("*.py"))
...
TEST_REQUIREMENTS = ["mock", "nose", "dxlmaxmindservice", "astroid<2.3.0", "pylint<=2.3.1"]
...
setup(
    ...
    packages=[
        "dxlmaxmindclient",
        "dxlmaxmindclient._config",
        "dxlmaxmindclient._config.sample"],
